...
(function(b) {
    ...
    n.prototype = {
        ...
        init: function() {
            ...
            this.board.setSection(-.5, -.5, -.5, -.5);
            this.board.addCustomObject(b.Board.coordinates);
...
(function(b, p) {
    ...
    b.i18n.en.comments = "Game Info";
    b.i18n.en.gameinfo = "Score";
        ...
        args: {
            ...
            widgets: [{
                ...
                args: {
                    ...
                    togglable: !0,
                    click: function(d) {
                        if (d.kifuReader.game.stack.length > 2) {
                            if((d.kifuReader.game.turn == 1 && b.skipWhite) ||(d.kifuReader.game.turn == -1 && b.skipBlack)){
                            	alert("Les deux joueurs ont fait un skip");
                            	b.skipFinish = true;
                            	d.setFrozen(!0);
                            ...
                            if (d.kifuReader.game.turn == 1 && !b.skipFinish) {
                                alert("Le joueur noir a fait un skip");
                                b.skipBlack = true;
                                d.kifuReader.game.turn = -1;
                            }
                            else if (d.kifuReader.game.turn == -1 && !b.skipFinish) {
                                alert("le joueur blanc a fait un skip");
                                b.skipWhite = true;
                                d.kifuReader.game.turn = 1;
                            }                   
...
(function(b) {
    ...
    b.Player.Editable.prototype.play = function(f, g) {
    	if(this.player.kifuReader.game.turn == 1 && b.skipWhite)
    		b.skipWhite = false;
    	if(this.player.kifuReader.game.turn == -1 && b.skipBlack)
    		b.skipBlack = false;
