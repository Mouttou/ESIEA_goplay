(function(v, q) {
    ...
    g.t =
        function(a) {
            ...
            if (b) {
                for (var c = 1; c < arguments.length; c++) b = b.replace("$", arguments[c]);
                return b
            }
            return a
        };
    ...
    var h = function(a, b) {
        ...
        for (c in g.Board.default) this[c] === q && (this[c] = g.Board.default[c]);
        for (c in h.themes.default) this.theme[c] === q && (this.theme[c] = h.themes.default[c]);
    ...
    h.drawHandlers = {
            ...
            stone: {
                draw: function(a, b) {
                    var c = b.getX(a.x),
                        ...
                        d = b.stoneRadius,
                        f;
                    a.c == g.W ? (f = this.createRadialGradient(c - 2 * d / 5, e - 2 * d / 5, d / 3, c - d / 5, e - d / 5, 5 * d / 5), f.addColorStop(0, "#fff"), f.addColorStop(1, "#aaa")) : (f = this.createRadialGradient(c -
                        2 * d / 5, e - 2 * d / 5, 1, c - d / 5, e - d / 5, 4 * d / 5), f.addColorStop(0, "#666"), f.addColorStop(1, "#000"));
                    this.beginPath();
                    this.fillStyle = f;
            ...
            stone: {
                draw: function(a, b) {
                    var c = b.getX(a.x),
                        ...
                        d = b.stoneRadius,
                        f;
                    a.c == g.W ? (f = this.createRadialGradient(c - 2 * d / 5, e - 2 * d / 5, 2, c - d / 5, e - d / 5, 4 * d / 5), f.addColorStop(0, "#fff"), f.addColorStop(1, "#ddd")) : (f = this.createRadialGradient(c - 2 * d / 5, e - 2 * d / 5, 1, c - d / 5, e - d / 5, 4 * d / 5), f.addColorStop(0, "#111"),
            ...
            stone: {
                draw: function(a, b) {
                    var c = b.getX(a.x),
                        ...
                        d = b.stoneRadius,
                        f;
                    a.c == g.W ? (f = this.createRadialGradient(c - 2 * d / 5, e - 2 * d / 5, d / 3, c - d / 5, e - d / 5, 8 * d / 5), f.addColorStop(0,
                        "#fff"), f.addColorStop(1, "#666")) : (f = this.createRadialGradient(c - 2 * d / 5, e - 2 * d / 5, 1, c - d / 5, e - d / 5, 3 * d / 5), f.addColorStop(0, "#555"), f.addColorStop(1, "#000"));
                    this.beginPath();
                    this.fillStyle = f;
                    this.arc(c - b.ls, e - b.ls, Math.max(0, d - .5), 0, 2 * Math.PI, !0);
                    this.fill()
        ...
        SHELL: {
            stone: {
                draw: function(a, b) {
                    ...
                    this.beginPath();
                    this.fillStyle = f;
                    this.arc(c - b.ls, e - b.ls, Math.max(0,
                        d - .5), 0, 2 * Math.PI, !0);
                    this.fill()
                }
            },
            ...
            grid: {
                ...
                clear: function(a, b) {
                    if (!D(b, a.x, a.y)) {
                        ...
                        for (e = 0; e < b.obj_list.length; e++) g = b.obj_list[e], c = g.handler, c.grid && c.grid.draw.call(b.grid.getContext(g.args), g.args,
                            b);
                        delete a._nodraw
                    }
                }
        ...
        MA: {
            stone: {
                draw: function(a, b) {
                    ...
                    this.moveTo(Math.round(c +
                        d / 2) - 1, Math.round(e - d / 2));
        ...
        mini: {
            stone: {
                draw: function(a, b) {
                    b.stoneRadius /= 2;
                    a.stoneStyle ? h.drawHandlers[a.stoneStyle].stone.draw.call(this,
                        a, b) : b.stoneHandler.stone.draw.call(this, a, b);
                    b.stoneRadius *= 2
                }
            }
        }
    ...
    h.coordinates = {
        grid: {
            draw: function(a, b) {
                ...
                g = b.getY(-.75);
                h = b.getY(b.size - .25);
                for (var l = 0; l < b.size; l++) c = l + 65, 73 <= c && c++, e = b.getY(l), this.fillText(b.size - l, d, e), this.fillText(b.size - l, f, e), e = b.getX(l), this.fillText(String.fromCharCode(c), e, g), this.fillText(String.fromCharCode(c),
                    e, h);
    ...
    h.GridLayer.prototype.draw = function(a) {
        ...
        this.context.strokeStyle = k("gridLinesColor",
            a);
        ...
        for (var g = 1; g < a.size - 1; g++) b = Math.round(a.getX(g)) - a.ls, this.context.moveTo(b, e), this.context.lineTo(b, e + f), b = Math.round(a.getY(g)) - a.ls, this.context.moveTo(c, b), this.context.lineTo(c + d, b);
        this.context.stroke();
        this.context.fillStyle = k("starColor", a);
        if (a.starPoints[a.size])
            for (var h in a.starPoints[a.size]) this.context.beginPath(),
    ...
    h.MultipleCanvasLayer.prototype.init = function(a) {
        ...
        this.contexts = [];
        this.pixelRatio = v.devicePixelRatio || 1;
        for (var e = 0; e < a; e++) b = document.createElement("canvas"), c = b.getContext("2d"), 1 < this.pixelRatio && c.scale(this.pixelRatio, this.pixelRatio),
            this.elements.push(b), this.contexts.push(c)
    };
    h.MultipleCanvasLayer.prototype.appendTo = function(a, b) {
        for (var c = 0; c < this.layers; c++) this.elements[c].style.position = "absolute", this.elements[c].style.zIndex = b, a.appendChild(this.elements[c])
    };
    ...
    h.MultipleCanvasLayer.prototype.clear = function(a, b) {
        for (var c = 0; c < this.layers; c++) this.contexts[c].clearRect(0, 0, this.elements[c].width, this.elements[c].height)
    };
    h.MultipleCanvasLayer.prototype.setDimensions = function(a, b) {
        for (var c = 0; c < this.layers; c++) this.elements[c].width = a, this.elements[c].style.width = a / this.pixelRatio + "px", this.elements[c].height = b, this.elements[c].style.height = b / this.pixelRatio + "px"
    };
    ...
    h.ShadowLayer.prototype.setDimensions = function(a, b) {
        ...
        for (var c = 0; c < this.layers; c++) this.contexts[c].setTransform(1, 0, 0, 1, Math.round(this.shadowSize * this.board.stoneRadius / 7), Math.round(this.shadowSize * this.board.stoneRadius / 7))
    };
    var E = function(a, b) {
            var c = b.getX(a.x),
                e = b.getY(a.y),
        ...
        B = function(a, b) {
            for (var c, e = 0; e < this.obj_arr[a][b].length; e++) {
                ...
                for (var f in c) c[f].clear ? c[f].clear.call(this[f].getContext(d), d, this) : E.call(this[f].getContext(d), d, this)
            }
        },
        x = function(a, b) {
            for (var c,
                    e = 0; e < this.obj_arr[a][b].length; e++) {
                var d = this.obj_arr[a][b][e];
                c = d.type ? "string" == typeof d.type ? h.drawHandlers[d.type] : d.type : this.stoneHandler;
        ...
        C = function() {
            ...
            for (var a = 0; a < this.layers.length; a++) this.layers[a].setDimensions(this.width, this.height)
        };
    h.prototype = {
        constructor: h,
        init: function() {
        ...
        setWidth: function(a) {
            ...
            this.fieldHeight = this.fieldWidth = 4 * this.width / (4 * (this.bx + 1 -
                this.tx) + 2);
        ...
        setSection: function(a, b, c, e) {
            this.section = "object" == typeof a ? a : {
                top: a,
                right: b,
                bottom: c,
                left: e
            ...
            this.bx = this.size - 1 - this.section.right;
            this.by =
                this.size - 1 - this.section.bottom;
            this.setDimensions()
        },
        setSize: function(a) {
            a = a || 19;
        ...
        redraw: function() {
            try {
                for (var a = 0; a < this.layers.length; a++) this.layers[a].clear(this), this.layers[a].draw(this);
                for (a = 0; a < this.size; a++)
                    for (var b = 0; b < this.size; b++) x.call(this, a,
                        b);
        ...
        update: function(a) {
            ...
            if (a.remove && "all" == a.remove) this.removeAllObjects();
                ...
                for (b = 0; b < a.remove.length; b++) this.removeObject(a.remove[b]);
            if (a.add)
                for (b = 0; b < a.add.length; b++) this.addObject(a.add[b])
        },
    ...
    m.prototype = {
        ...
        play: function(a, b, c, e) {
            ...
            if (!h.length) {
                ...
                if (u(d, k, a, b, c))
                    if (this.allow_suicide) f = -c, t(d, h, a, b, c);
                    else return 3
            }
            if (k = this.repeating) {
                a: {
                    var m;
                    if ("KO" == this.repeating && 0 <= this.stack.length - 2) m = this.stack.length - 2;
            ...
            f == g.B ? d.capCount.black +=
                h.length : d.capCount.white += h.length;
            this.pushPosition(d);
            this.turn = -c;
            return h
        },
        ...
        popPosition: function() {
            var a = null;
            0 < this.stack.length &&
                (a = this.stack.pop(), this.turn = 0 == this.stack.length ? g.B : this.position.color ? -this.position.color : -this.turn);
            return a
        },
        ...
        validatePosition: function() {
            for (var a, b, c = 0, e = 0, d = [], f = this.position.clone(), h = 0; h < this.size; h++)
                for (var k = 0; k < this.size; k++)
                    if (a = this.position.get(h,
                            k)) b = d.length, d = d.concat(l(f, h - 1, k, -a), l(f, h + 1, k, -a), l(f, h, k - 1, -a), l(f, h, k + 1, -a)), a == g.B ? e += d - b : c += d - b;
